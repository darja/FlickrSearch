...
public class DPLog {
    private static String tag = "FlickrSearch";
    ...
    public static void et(String tag, Throwable e, String format, Object... args) {
        if (isEnabled(tag)) {
            android.util.Log.e(tag, String.format(format, args) + getLocation(), e);
        }
    }
